...
>     delnab = delta <+> nabla
>     help B0                                     B0            t = t
>     help (delta   :< E _ (x, _)  (Parameter _) _)     B0            t = help delta B0 (L (x :. t))
>     help (delta   :< _)                         B0            t = help delta B0 t
>     help (delnab  :< E _ (x, _)  (Parameter LAMB) _)  (nabla :< _)  t = 
>         help delnab nabla (L (x :. t))
>     help (delnab  :< E _ (x, _)  (Parameter ALAB) _)  (nabla :< _)  t = 
>         help delnab nabla (L (x :. t))
>     help (delnab  :< E _ (x, _)  (Parameter PIB) s)   (nabla :< _)  t = 
...
>   where boy (E r _ (Parameter _) t) = [r :<: t]
>         boy _ = []
...
> inferGoalType (es :< E _ (x,_)  (Parameter LAMB)  s)  t        = inferGoalType es (PI (es -| s) (L (x :. t)))
> inferGoalType (es :< E _ (x,_)  (Parameter ALAB)  s)  (PRF t)  = inferGoalType es (PRF (ALL (es -| s) (L (x :. t))))
> inferGoalType (es :< E _ (x,_)  (Parameter PIB)   s)  SET      = inferGoalType es SET
