...
inspired by the *hierarchical names* @mcbride:free_variable used in
...
Therefore, creating a fresh name in a given namespace simply consists of
incrementing the name counter:

> freshName :: NameSupply -> NameSupply
> freshName (sis, i) = (sis, i + 1)

Whereas creating a fresh namespace involves stacking up a new name |s|,
uniquely identified by |i|, and initializing the per-namespace counter
to |0|:
