...
deBruijn indices (in the hope that somebody out there will
$\lambda$-abstract them). It gets used when quoting
$\lambda$-abstractions in values, and when building
$\lambda$-abstractions in the proof state.
