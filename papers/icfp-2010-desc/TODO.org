...
* TODO "bind" and "return" is not a nice way of writing 
...
* TODO Uniformize spacing in array @{\:()\:\:}
...
* TODO Cool down the many "intuitively"
* TODO composed by/composed of
* TODO Shall we present EnumU with tags as constructors, directly?
* TODO Finite set declaration: should be EnumT [a, b, c]
...
* TODO Quotes on sum-of-product, or not, or maybe. Same for sigmas-of-sigmas
...
* TODO {ExprD_{Free}}_Ty might be a bit to much
