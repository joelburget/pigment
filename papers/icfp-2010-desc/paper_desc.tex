...
\note{Any idea of other papers?}.  \note{Is that really a motivating
  motivation for the usage of universe construction?}  \note{pwm:
  Surely ($\EnumU$, $\EnumT$) is a useful example of universes too.
...
Codes being mere labels, we can inspect them, hence regaining
