...
transitivity. Further, it also encompasses the $\beta$-rules for
function application and pairs. Finally, equality under lambda is
dealt with by the $\xi$-rule.
...
glance, this seems to contradict our argument in favour of types for
