...
by $\Bhab{\V{I}}{\Set}$, we rely on endofunctors on the category
$\Set^I$. We call these \emph{indexed functors}. In the following, $I
\To \IDesc{I}$ is a grammar for indexed functors: \note{pwm: What's
  our story \emph{vis-\`{a}-vis} the 2 notions of indexed functor at
  play here: $(I\to\Set)\to\Set$ and $(I\to\Set)\to(I\to\Set)$?}
...
Figure~\ref{fig:idesc}. A fix-point consists of the fix-point of the
\emph{family} of functors as a whole. Hence the following definition:
