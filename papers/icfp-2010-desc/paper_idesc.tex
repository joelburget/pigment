...
We use the notation $\toIDesc{\V{\CN{TID}}}$ to denote the indexed
description computed from the tagged indexed description
$\V{TID}$. Its expansion is similar to the definition of
\(\SYMBtoDesc\) for tagged descriptions.
