...
$\Set^{\V{I}}$. We call these \emph{indexed functors}. \note{Predicate
  transformer anyone?} $\V{I} \To \IDesc{\V{I}}$ is our
...
\To \Set^{\V{I}}$.The fix-point of inductive families is defined over
...
evolving $\Desc$ to cope with indexing. The step-by-step
transformation is described in our technical report. The code of
$\IDesc{\!}$ is presented in Figure~\ref{fig:idesc}. The induction
scheme on $\IDesc{\!}$ has the following type:
...
Where the operator $\AllI{\!}{\!}{\!}{\!}$ is of type:

\[
\AllI{\!}{\!}{\!}{\!} : _{\Bhab{\V{I}}{\Set}}
                        \PITEL{\V{D}}{\IDesc{\V{I}}}
                        \PI{\V{P}}{\V{I} \To \Set}
                        \idescop{\V{D}}{\V{I}}{\V{P}} \To
                        \IDesc{(\SIGMA{\V{i}}{\V{I}} \V{P})} 
\]

The implementation of these operators can be found in the companion
technical report. As for descriptions, we can compute a generic
catamorphism, $\F{cataI}$, from $\F{inductionI}$.
...
Hence completing our implementation of the open terms interpreter. We
