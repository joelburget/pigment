...
\substH  : & \PITEL{\V{ty}}{\Ty}
           ...
           & (\PI{\V{ty}}{\Ty}
              (\SUM{\Val{\V{ty}}}{\Var{\V{G}}{\V{ty}}}) \To
              \IMu{\Ty}{\HExprD}{\V{ty}}) \\
          & \To \IMu{\Ty}{\HExprVarD{\V{G}}}{\V{ty}} \To 
            \IMu{\Ty}{\HExprD}{\V{ty}}
\end{array}
\]
...
\substI : & _{\PI{\V{I}}{\Set}}
          ...
          & (\PI{\V{i}}{\V{I}} \V{X}\:\V{i} \To 
                               \IMu{\V{I}}{(\FreeIMonad{\V{R}}{\V{I}}{\V{Y}})}{\V{i}}) \To \\
          & \PI{\V{i}}{\V{I}}
            \IMu{\V{I}}{(\FreeIMonad{\V{R}}{\V{I}}{\V{X}})}{\V{i}} \To
            \IMu{\V{I}}{(\FreeIMonad{\V{R}}{\V{I}}{\V{Y}})}{\V{i}}
\end{array} \\
...
\F{applyI} : & _{\PI{\V{I}}{\Set}}
            \PITEL{\V{R}}{\TagIDesc{\V{I}}}
            \PI{\V{X}, \V{Y}}{\V{I} \To \Set} \\
          & (\PI{\V{i}}{\V{I}} \V{X}\: \V{i} \To \IMu{\V{I}}{(\FreeIMonad{\V{R}}{\V{I}}{\V{Y}})}{\V{i}}) \To \\
          & \PI{\V{i}}{\V{I}} 
