...
\FinD\: (\NatSuc{\V{n}}) & \mapsto & \DSigma{\!}{\!}\!\!\!\!\! & (\EnumT{\sqr{ \FinZero \: \FinSuc{\!} }}) \\
                     &   &             & \bigRedBracket{
                                         \begin{array}{l}
                                         \DConst{\Unit} \\
                                         \DVar{\V{n}}
...
$\V{TID}$. Its expansion is similar to the definition of \(\toDesc{\!}\)
but more involved.
...
\HExprID \mapsto \bigRedBracket{
                 \begin{array}{l}
                   \sqr{\sqr{\Eplus{\!}{\!}} \quad \sqr{\Ele{\!}{\!}}} \red{,} \\
