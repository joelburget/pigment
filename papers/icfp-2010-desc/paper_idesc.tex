...
$\DUnit$ was interpreted as the unit set, $\DConst{\V{X}}$ is interpreted
as $\V{X}$, for any $\Bhab{\V{X}}{\Set}$. Extensionally, $\DConst{\V{X}}$ and
$\DSigma{\V{X}}{\DUnit}$ are equivalent. However, $\DConst$ is more
...
pattern functor of natural numbers. We refer the reader to
...
\begin{array}{@{}ll}
\IDescD~\V{I} \mapsto \DSigma{}{} & (\EnumT \red{[} \DVar{},
                                          \DConst{},
                                          \DProd{}{},
                                          \DSigma{}{}, 
                                          \DPi{}{} \red{]}) \\
...
\begin{array}{@{}ll}
\FinD\: \V{n} = \DSigma{}{} \!\!\!\!\!\!& (\EnumT{[ \FinZero , \FinSuc{} ]}) \\
                        & \bigRedBracket{
                          \begin{array}{l}
                            \DSigma{\Nat}{\LAM{\V{m}} \DConst{(\V{n} \PropEq \NatSuc{\V{m}})}} \\
                            \DSigma{\Nat}{\LAM{\V{m}} \DProd{\DVar{\V{m}}}{\DConst{(\V{n} \PropEq \NatSuc{\V{m}})}}}
                          \end{array}
                          }
\end{array}
}\]
...
element $\V{m}$ of $\Nat$, thanks to a $\DSigma$. However, the constraint
stipulates that $\V{m}$ cannot be \emph{any} natural numbers: it must be
``the index minus one''. This translates into the constraint $\V{n}
\PropEq \NatSuc{\V{m}}$. 
...
eradicated, or presented more conveniently to the user. Finally, it is
worth mentioning that the forcing optimisation is a
...
pattern functor, trivially indexed by $\Unit$. Hence, we describe
this functor by the following code:

\[\stk{
\IDescFreeD : \PI{\V{I}}{\Set} \IDesc{\Unit} \\
\begin{array}{@{}ll}
\IDescFreeD~\V{I} \mapsto \DSigma{}{} & (\EnumT \red{[} \DConst{},
                                              \DProd{}{},
                                              \DSigma{}{}, 
                                              \DPi{}{} \red{]}) \\
                                  & \bigRedBracket{\begin{array}{l}
