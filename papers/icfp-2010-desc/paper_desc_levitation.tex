...
In this section, we try a more ambitious generic operation. Given a functor,
represented as a tagged description, we
build its free monad.
%
...
Our free monad construction takes the functor as a
