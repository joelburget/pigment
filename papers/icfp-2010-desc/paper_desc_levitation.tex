...
decide between two variants. The solution to this problem stands, once
again, in the type propagation system. Just as the $\F{switch}$
operator, $\F{switchD}$ can be automatically elaborated. To this end,
we simply extend the type-checking rules
